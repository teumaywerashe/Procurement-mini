              ...
              {editing ? (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1.5 rounded-md border border-[var(--border)] text-[var(--text-subtle)] hover:text-[var(--text-primary)] transition-colors"
                  >
                    <IconX size={15} />
                  </button>
                </div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-1 rounded text-[var(--text-faint)] hover:text-[var(--text-primary)] transition-colors"
                    title="Edit name"
                  >
                    <IconEdit size={14} />
                  </button>
        ...
        {isVendor && vendor && (
          <div className="bg-[var(--bg-surface)] border border-[var(--border)] rounded-2xl overflow-hidden">
            ...
            <div className="px-8 py-6 space-y-4">
              ...
              {vendor.contactPhone && (
                <InfoRow icon={<IconPhone size={15} />} label="Phone" value={vendor.contactPhone} />
              )}
              {vendor.address && (
                <InfoRow icon={<IconMapPin size={15} />} label="Address" value={vendor.address} />
              )}
              <InfoRow
                icon={<IconCalendar size={15} />}
                label="Registered"
                value={new Date(vendor.createdAt).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}
              />
            </div>
          </div>
        )}
