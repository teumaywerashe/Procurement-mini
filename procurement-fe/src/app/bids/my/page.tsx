    ...
    <div className="min-h-screen bg-[#0f0e0b] text-white flex flex-col">
      ...
      <div className="max-w-4xl mx-auto w-full px-6 py-8 flex-1">
        ...
        <div className="mb-6">
          ...
          <p className="text-xs text-zinc-500 mt-0.5">Track the status of your submitted bids</p>
        </div>
        ...
        {!isLoading && bids.length > 0 && (
          <div className="flex items-center gap-3 mb-6 flex-wrap">
            <div className="flex items-center gap-2 px-3 py-1.5 bg-[#1c1a16] border border-[#2a2620] rounded-lg">
              ...
              <span className="text-xs font-bold text-white tabular-nums">{bids.length}</span>
            </div>
          ...
          {isLoading ? (
            <div className="p-6 space-y-3">
              {Array.from({ length: 4 }).map((_, i) => (
                <div key={i} className="h-14 bg-[#14120e] rounded animate-pulse" />
              ))}
            </div>
          ) : isError ? (
            ...
            <div className="flex flex-col items-center py-16 gap-3">
              ...
              <p className="text-sm text-zinc-500">You haven&apos;t submitted any bids yet.</p>
              <Link
                href="/tender"
              ...
              return (
                ...
                >
                  <Link href={`/tender/${bid.tenderId}`} className="group min-w-0">
                    ...
                    <p className="text-[11px] text-zinc-600 mt-0.5">Bid #{bid.id}</p>
                  </Link>
