...
export function ManageLeftSidebar({
  tenders,
  statusFilter,
  onStatusChange,
}: LeftProps) {
            ...
            {STATUS_FILTERS.map((f) => {
              ...
              return (
                ...
                >
                  ...
                  <span
                    className={`text-[10px] font-semibold tabular-nums px-1.5 py-0.5 rounded-full ${statusFilter === f.value ? "bg-indigo-600/30 text-indigo-300" : "bg-[var(--bg-elevated)] text-[var(--text-faint)]"}`}
                  >
                    {count}
                  </span>
                </button>
