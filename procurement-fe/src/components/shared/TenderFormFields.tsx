...
const INPUT_ERR = "w-full bg-(--bg-input) border border-red-500 rounded-lg px-4 py-2.5 text-sm text-(--text-primary) placeholder-(--text-faint) outline-none focus:border-red-400 transition-colors";
...
export default function TenderFormFields({ form, onChange, errors = {} }: Props) {
  return (
    <>
      <div>
