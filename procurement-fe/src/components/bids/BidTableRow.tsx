...
export default function BidTableRow({ bid, tender }: Props) {
  ...
  return (
    <div className="grid grid-cols-[1fr_130px_160px_120px] gap-4 px-5 py-4 border-b border-[var(--border-subtle)] hover:bg-[var(--bg-elevated)] transition-colors items-center">
